...
* Start the GitHub https://github.com/bonitasoft/bonita-connector-slack/actions/workflows/release.yml[release] action. You'll have to define the release version, which should match the pom.xml version.
